...
/**
* @class
* @classdesc This contians the basic functions available to alignments.
* @param {Object} options
* @param {Number} [options.min_intron=68] - The smallest size gap to consider an intron.
* @memberof alignment
*/
class GenericAlignment {
  ...
  * @instance
  * @param {Number} min_intron
  * @returns {Number} min_intron
  * @memberof alignment.GenericAlignment
  */
  get min_intron () {
  ...
  * @instance
  * @param {Object} refDict - Dictionary keys are chromosome names, values are sequences
  * @memberof alignment.GenericAlignment
  */
  set ref (refDict) {
    this._ref = refDict;
  ...
  * @instance
  * @param {Number} [linelength=50] - how long to make the pretty print line
  ...
  * @instance
  * @param {Object} [options={}] - not necessary to be set to call
