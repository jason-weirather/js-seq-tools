...
* @param {String} options.sam_line - a complete sam line
* @memberof formats.alignment.sam
*/
class SAM extends GenericAlignment {
  ...
  * @memberof formats.alignment.sam.SAM
  */
  ...
  get _map () {
    ...
    for (let i = 0; i < this.cigar.ops.length; i++) {
      ...
      if (op === 'S' && soft_count === 0) { // make sure we are only working with the first soft clipping to do an offset
        soft_count += 1;
        //refs[re].start += num; // Soft cliping doesn't adjust the first match position
        //refs[re].end += num;
  ...
  * @instance
  * @param {Object} options - can pass options to AlignmentDerivedMapping
  ...
  * @instance
  * @readonly
  * @param {String} intext - provide a sam line
...
* @class
* @param {Array} aux - An array of auxillary tags/information
* @memberof formats.alignment.sam
*/
class SAMAuxillary {
  constructor (aux) {
  ...
  * @memberof formats.alignment.sam.SAMAuxillary
  */
  get tags () {
...
* @class
* @param {String} cigar_string - input the cigar string as a string type
* @memberof formats.alignment.sam
*/
class CIGAR {
  ...
  * @memberof formats.alignment.sam.CIGAR
  */
  get ops () {
...
* @class
* @extends Transform
* @param {Object} options - options for the transform object
* @memberof formats.alignment.sam
*/
...
* @class
* @param {Object} options - options for the transform object
* @param {Object} options.text - the header data
* @memberof formats.alignment.sam
*/
class SAMHeader {
  constructor(options) {
  ...
  * @memberof formats.alignment.sam.SAMHeader
  */
  get n_ref () {
