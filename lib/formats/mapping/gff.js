...
/**
* The gff module has classes for working with groups of GFF data lines
* @namespace gff
* @memberof formats.mapping
*/

/**
* A helper function to construct objects that are the same type as the object given
* @param {Object} obj - the object that has the prototype you want to be using
* @param {Object} params - the parameters you want to pass to the constructor
* @memberof formats.mapping.gff
*/
...
/**
* A GFF transcript class . for the purposes of outputting transcripts contained in a GFF file and maintaining the extra info
* @class
* @param {Object} options - it passes these options to parent for other options
* @param {String} options.Parent - you can pass in the parent ID.  This is only useful for GFF3
* @param {String} options.ID - you can passin the ID in GFF3 if you want
* @memberof formats.mapping.gff
*/
